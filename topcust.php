...
<div class="headerplace">You are here >>Top Customer Information >> <a href="index1.php?top_customer">Report </a></div>

<center>
<table border="0" width="480px">
<form action="topcust1.php" onsubmit="return formfuc()" method="POST">
<br/>
